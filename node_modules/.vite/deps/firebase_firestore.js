...
var na = Array.prototype.forEach ? function(a, b, c) {
  ...
  var d2 = a.length, e = "string" === typeof a ? a.split("") : a;
  for (var f = 0; f < d2; f++)
...
function oa(a) {
  a: {
    var b = pa;
    var c = a.length, d2 = "string" === typeof a ? a.split("") : a;
    for (var e = 0; e < c; e++)
...
function A(a, b) {
  ...
  if (a) {
    ...
    d2 ? (this.clientX = void 0 !== d2.clientX ? d2.clientX : d2.pageX, this.clientY = void 0 !== d2.clientY ? d2.clientY : d2.pageY, this.screenX = d2.screenX || 0, this.screenY = d2.screenY || 0) : (this.clientX = void 0 !== a.clientX ? a.clientX : a.pageX, this.clientY = void 0 !== a.clientY ? a.clientY : a.pageY, this.screenX = a.screenX || 0, this.screenY = a.screenY || 0);
...
function ib(a, b, c, d2, e, f) {
  ...
  if (a.addEventListener)
    Va || (e = h), void 0 === e && (e = false), a.addEventListener(b.toString(), d2, e);
...
function nb(a, b, c, d2, e) {
  if (Array.isArray(b))
    ...
    (d2 = p(d2) ? !!d2.capture : !!d2, c = hb(c), a && a[B]) ? (a = a.i, b = String(b).toString(), b in a.g && (f = a.g[b], c = ab(f, c, d2, e), -1 < c && (Za(f[c]), Array.prototype.splice.call(f, c, 1), 0 == f.length && (delete a.g[b], a.h--)))) : a && (a = jb(a)) && (b = a.g[b.toString()], a = -1, b && (a = ab(b, c, d2, e)), (c = -1 < a ? b[a] : null) && ob(c));
}
function ob(a) {
...
function tc(a, b, c) {
  ...
  4 != b || 0 != c.length || a.h.h || (a.o = 1, J(16), d2 = false);
  a.i = a.i && d2;
        ...
        for (e = c.Ca.g.parse(b), b = 0; b < e.length; b++) {
          ...
          if (2 == c.G)
            if ("c" == m[0]) {
              ...
              var Da2 = m[5];
              null != Da2 && "number" === typeof Da2 && 0 < Da2 && (d2 = 1.5 * Da2, c.K = d2, c.h.info("backChannelRequestTimeoutMs_=" + d2));
              d2 = c;
              var ca2 = a.g;
              if (ca2) {
...
function Gd(a, b, c) {
  ...
  d2 || (c = Fd(c), "string" === typeof a ? null != c && encodeURIComponent(String(c)) : R(a, b, c));
}
function Hd(a, b, c) {
  ...
  if (0 != a.G) {
    if (b.i)
      if (1 == d2) {
        ...
        Gc(a);
    else if (e = b.o, 3 == e || 0 == e && 0 < a.I || !(1 == d2 && Nd(a, b) || 2 == d2 && Bc(a)))
...
var M2 = (
  ...
  function() {
    ...
    return t2.u = function() {
      for (var t3 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789", e = Math.floor(256 / t3.length) * t3.length, n = ""; n.length < 20; ) for (var r = F2(40), i = 0; i < r.length; ++i)
...
var B2 = (
  ...
  function() {
    function t2(t3, e) {
      if (this.seconds = t3, this.nanoseconds = e, e < 0) throw new N2(S2.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
      if (e >= 1e9) throw new N2(S2.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
      if (t3 < -62135596800) throw new N2(S2.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t3);
      if (t3 >= 253402300800) throw new N2(S2.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t3);
    }
...
var z2 = (
  ...
  function() {
    function t2(t3, e, n) {
      void 0 === e ? e = 0 : e > t3.length && L2(), void 0 === n ? n = t3.length - e : n > t3.length - e && L2(), this.segments = t3, this.offset = e, this.len = n;
    }
  ...
  function(e) {
    ...
    n.fromString = function() {
      ...
      for (var r = [], i = 0, o = t2; i < o.length; i++) {
        var s = o[i];
        if (s.indexOf("//") >= 0) throw new N2(S2.INVALID_ARGUMENT, "Invalid segment (" + s + "). Paths must not contain // in them.");
  ...
  function(e) {
    ...
    n.fromServerFormat = function(t2) {
      for (var e2 = [], r = "", i = 0, o = function() {
        if (0 === r.length) throw new N2(S2.INVALID_ARGUMENT, "Invalid field path (" + t2 + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
        e2.push(r), r = "";
      }, s = false; i < t2.length; ) {
        var u = t2[i];
        if ("\\" === u) {
          if (i + 1 === t2.length) throw new N2(S2.INVALID_ARGUMENT, "Path has trailing escape character: " + t2);
          var a = t2[i + 1];
          if ("\\" !== a && "." !== a && "`" !== a) throw new N2(S2.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t2);
          r += a, i += 2;
        } else "`" === u ? (s = !s, i++) : "." !== u || s ? (r += u, i++) : (o(), i++);
      }
      if (o(), s) throw new N2(S2.INVALID_ARGUMENT, "Unterminated ` in path: " + t2);
      return new n(e2);
    }, n.emptyPath = function() {
      return new n([]);
    }, n;
...
function et(t2) {
  return "string" == typeof t2 ? X2.fromBase64String(t2) : X2.fromUint8Array(t2);
}
function nt(t2) {
  var e, n;
...
function ut(t2) {
  return "number" == typeof t2 && Number.isInteger(t2) && !st(t2) && t2 <= Number.MAX_SAFE_INTEGER && t2 >= Number.MIN_SAFE_INTEGER;
}
var at = (
  /** @class */
  function() {
    ...
    t2.prototype.hasCollectionId = function(t3) {
      ...
      return null !== t3 && 0 === W2.comparator(this.path, t3.path);
    }, t2.prototype.toString = function() {
...
function ht(t2, e) {
  ...
  switch (n) {
    ...
    case 2:
      return function(t3, e2) {
        if ("integerValue" in t3 && "integerValue" in e2) return tt(t3.integerValue) === tt(e2.integerValue);
    ...
    case 10:
      return function(t3, e2) {
        ...
        if (K2(n2) !== K2(r)) return false;
        for (var i in n2) if (n2.hasOwnProperty(i) && (void 0 === r[i] || !ht(n2[i], r[i]))) return false;
        return true;
      }(t2, e);
    default:
      return L2();
  ...
  switch (n) {
    ...
    case 8:
      return function(t3, e2) {
        ...
        return 0 !== n2 ? n2 : V2(tt(t3.longitude), tt(e2.longitude));
...
function dt(t2, e) {
  if ("string" == typeof t2 && "string" == typeof e && t2.length === e.length) return V2(t2, e);
  var n = Z2(t2), r = Z2(e), i = V2(n.seconds, r.seconds);
  return 0 !== i ? i : V2(n.nanos, r.nanos);
}
function pt(t2) {
  return yt(t2);
}
...
function Et(t2) {
  ...
  if (t2.arrayValue) {
    ...
    }, r = 0; r < (t2.arrayValue.values || []).length; ++r) n.arrayValue.values[r] = Et(t2.arrayValue.values[r]);
    return n;
  }
...
var Tt = (
  ...
  function() {
    ...
    t2.prototype.field = function(t3) {
      ...
      for (var e = this.value, n = 0; n < t3.length - 1; ++n) if (!It(e = (e.mapValue.fields || {})[t3.get(n)])) return null;
...
function Dt(t2, e, n, r, i, o, s) {
  return void 0 === e && (e = null), void 0 === n && (n = []), void 0 === r && (r = []), void 0 === i && (i = null), void 0 === o && (o = null), void 0 === s && (s = null), new Nt(t2, e, n, r, i, o, s);
}
function At(t2) {
  var e = P2(t2);
  if (null === e.h) {
...
function kt(t2, e) {
  ...
  for (var n = 0; n < t2.orderBy.length; n++) if (!Kt(t2.orderBy[n], e.orderBy[n])) return false;
  if (t2.filters.length !== e.filters.length) return false;
  for (var r = 0; r < t2.filters.length; r++) if (i = t2.filters[r], o = e.filters[r], i.op !== o.op || !i.field.isEqual(o.field) || !ht(i.value, o.value)) return false;
  var i, o;
  return t2.collectionGroup === e.collectionGroup && !!t2.path.isEqual(e.path) && !!Gt(t2.startAt, e.startAt) && Gt(t2.endAt, e.endAt);
}
function Ct(t2) {
  return at.isDocumentKey(t2.path) && null === t2.collectionGroup && 0 === t2.filters.length;
}
var xt = (
  /** @class */
  function(e) {
    ...
    return __extends(n, e), n.create = function(t2, e2, r) {
      return t2.isKeyField() ? "in" === e2 || "not-in" === e2 ? this.l(t2, e2, r) : new Rt(t2, e2, r) : "array-contains" === e2 ? new Ft(t2, r) : "in" === e2 ? new Mt(t2, r) : "not-in" === e2 ? new Vt(t2, r) : "array-contains-any" === e2 ? new qt(t2, r) : new n(t2, e2, r);
    }, n.l = function(t2, e2, n2) {
      return "in" === e2 ? new Lt(t2, n2) : new Ot(t2, n2);
    }, n.prototype.matches = function(t2) {
      var e2 = t2.data.field(this.field);
      return "!=" === this.op ? null !== e2 && this.m(lt(e2, this.value)) : null !== e2 && ct(this.value) === ct(e2) && this.m(lt(e2, this.value));
...
var Mt = (
  ...
  function(e) {
    ...
    return __extends(n, e), n.prototype.matches = function(t2) {
      var e2 = t2.data.field(this.field);
      return null !== e2 && ft(this.value.arrayValue, e2);
    }, n;
  }(xt)
);
var Vt = (
...
function Qt(t2, e, n) {
  for (var r = 0, i = 0; i < t2.position.length; i++) {
    ...
    if (r = o.field.isKeyField() ? at.comparator(at.fromName(s.referenceValue), n.key) : lt(s, n.data.field(o.field)), "desc" === o.dir && (r *= -1), 0 !== r) break;
  }
...
function Gt(t2, e) {
  ...
  for (var n = 0; n < t2.position.length; n++) if (!ht(t2.position[n], e.position[n])) return false;
  return true;
}
var zt = (
  /**
...
function Yt(t2) {
  return !ot(t2.limit) && "F" === t2.limitType;
}
function $t(t2) {
  return !ot(t2.limit) && "L" === t2.limitType;
}
function Xt(t2) {
...
function te(t2) {
  ...
  if (null === e.p) {
    ...
    var n = Jt(e), r = Xt(e);
    if (null !== n && null === r)
      n.isKeyField() || e.p.push(new jt(n)), e.p.push(new jt(
        Y2.keyField(),
        "asc"
        /* ASCENDING */
      ));
...
function ee(t2) {
  var e = P2(t2);
  if (!e.T) if ("F" === e.limitType) e.T = Dt(e.path, e.collectionGroup, te(e), e.filters, e.limit, e.startAt, e.endAt);
  else {
...
function se(t2, e) {
  return e.isFoundDocument() && function(t3, e2) {
    var n = e2.key.path;
    return null !== t3.collectionGroup ? e2.key.hasCollectionId(t3.collectionGroup) && t3.path.isPrefixOf(n) : at.isDocumentKey(t3.path) ? t3.path.isEqual(n) : t3.path.isImmediateParentOf(n);
  }(t2, e) && function(t3, e2) {
...
function ae(t2, e, n) {
  var r = t2.field.isKeyField() ? at.comparator(e.key, n.key) : function(t3, e2, n2) {
    ...
    return null !== r2 && null !== i ? lt(r2, i) : L2();
  }(t2.field, e, n);
  switch (t2.dir) {
    case "asc":
      return r;
...
function Ce(t2, e, n) {
  t2 instanceof Oe ? function(t3, e2, n2) {
    ...
    De(t3.precondition, e2) && // We don't call `setHasLocalMutations()` since we want to be backwards
    // compatible with the existing SDK behavior.
    e2.convertToNoDocument(j.min());
  }(t2, e);
}
function xe(t2, e) {
...
function Re(t2, e) {
  return t2.type === e.type && !!t2.key.isEqual(e.key) && !!t2.precondition.isEqual(e.precondition) && !!function(t3, e2) {
    return void 0 === t3 && void 0 === e2 || !(!t3 || !e2) && q2(t3, e2, function(t4, e3) {
...
var He = (
  ...
  function() {
    ...
    t2.prototype.check = function() {
      ...
      if (t3 !== this.right.check()) throw L2();
      return t3 + (this.isRed() ? 0 : 1);
    }, t2;
  }()
);
He.EMPTY = null, He.RED = true, He.BLACK = false, // end LLRBEmptyNode
He.EMPTY = new /** @class */
(function() {
  function t2() {
    this.size = 0;
...
var ln = function(t2, e, n, r) {
  void 0 === n && (n = X2.EMPTY_BYTE_STRING), void 0 === r && (r = null), this.state = t2, this.targetIds = e, this.resumeToken = n, this.cause = r;
};
var dn = (
  /** @class */
  function() {
    function t2() {
      this.S = 0, /**
           ...
           */
      this.D = vn(), /** See public getters for explanations of these fields. */
      this.C = X2.EMPTY_BYTE_STRING, this.N = false, /**
...
var pn = (
  ...
  function() {
    function t2(t3) {
      ...
      this.H = Je(), /** A mapping of document keys to their set of target IDs. */
      this.J = yn(), /**
      ...
      this.G.forEach(function(r2, i2) {
        ...
        if (o) {
          if (r2.current && Ct(o.target)) {
            ...
            null !== e.H.get(s) || e.at(i2, s) || e.tt(i2, s, St.newNoDocument(s, t3));
          }
...
function Dn(t2, e) {
  var n = Sn(e);
  if (n.get(1) !== t2.databaseId.projectId) throw new N2(S2.INVALID_ARGUMENT, "Tried to deserialize key from different project: " + n.get(1) + " vs " + t2.databaseId.projectId);
  if (n.get(3) !== t2.databaseId.database) throw new N2(S2.INVALID_ARGUMENT, "Tried to deserialize key from different database: " + n.get(3) + " vs " + t2.databaseId.database);
  return new at(xn(n));
}
function An(t2, e) {
...
function On(t2, e) {
  ...
  return e.fieldTransforms.length > 0 && (n.updateTransforms = e.fieldTransforms.map(function(t3) {
    return function(t4, e2) {
      ...
      if (n2 instanceof we) return {
        fieldPath: e2.field.canonicalString(),
        removeAllFromArray: {
          values: n2.elements
        }
      };
      if (n2 instanceof Ie) return {
        fieldPath: e2.field.canonicalString(),
        increment: n2.A
      };
      throw L2();
...
function Pn(t2, e) {
  var n = e.currentDocument ? function(t3) {
    return void 0 !== t3.updateTime ? Ne.updateTime(Tn(t3.updateTime)) : void 0 !== t3.exists ? Ne.exists(t3.exists) : Ne.none();
  }(e.currentDocument) : Ne.none(), r = e.updateTransforms ? e.updateTransforms.map(function(e2) {
    return function(t3, e3) {
      var n2 = null;
      if ("setToServerValue" in e3) O2("REQUEST_TIME" === e3.setToServerValue), n2 = new ve();
        ...
        n2 = new we(i2);
      } else "increment" in e3 ? n2 = new Ie(t3, e3.increment) : L2();
...
function Mn(t2, e) {
  ...
  null !== e.collectionGroup ? (n.parent = An(t2, r), n.structuredQuery.from = [{
  ...
  return null !== s && (n.structuredQuery.limit = s), e.startAt && (n.structuredQuery.startAt = Un(e.startAt)), e.endAt && (n.structuredQuery.endAt = Un(e.endAt)), n;
}
function Vn(t2) {
  ...
  n.limit && (a = function(t3) {
    var e2;
    return ot(e2 = "object" == typeof t3 ? t3.value : t3) ? null : e2;
  }(n.limit));
  var c = null;
...
function qn(t2) {
  return t2 ? void 0 !== t2.unaryFilter ? [Wn(t2)] : void 0 !== t2.fieldFilter ? [zn(t2)] : void 0 !== t2.compositeFilter ? t2.compositeFilter.filters.map(function(t3) {
    return qn(t3);
...
function $n(t2) {
  for (var e = "", n = 0; n < t2.length; n++) e.length > 0 && (e = Jn(e)), e = Xn(t2.get(n), e);
  return Jn(e);
}
function Xn(t2, e) {
...
function Zn(t2) {
  var e = t2.length;
  if (O2(e >= 2), 2 === e) return O2("" === t2.charAt(0) && "" === t2.charAt(1)), W2.emptyPath();
...
nr.store = "mutationQueues", /** Keys are automatically assigned via the userId property. */
nr.keyPath = "userId";
var rr = function(t2, e, n, r, i) {
  this.userId = t2, this.batchId = e, this.localWriteTimeMs = n, this.baseMutations = r, this.mutations = i;
};
rr.store = "mutations", /** Keys are automatically assigned via the userId, batchId properties. */
rr.keyPath = "batchId", /** The index name for lookup of mutations by user. */
rr.userMutationsIndex = "userMutationsIndex", /** The user mutations index is keyed by [userId, batchId] pairs. */
...
cr.store = "targets", /** Keys are automatically assigned via the targetId property. */
cr.keyPath = "targetId", /** The name of the queryTargets index. */
...
hr.store = "targetDocuments", /** Keys are automatically assigned via the targetId, path properties. */
hr.keyPath = ["targetId", "path"], /** The index name for the reverse index. */
hr.documentTargetsIndex = "documentTargetsIndex", /** We also need to create the reverse index for these properties. */
...
lr.store = "collectionParents", /** Keys are automatically assigned via the collectionId, parent properties. */
...
dr.store = "clientMetadata", /** Keys are automatically assigned via the clientId properties. */
dr.keyPath = "clientId";
...
var Er = (
  ...
  function() {
    function t2(e, n, r) {
      ...
      // log on 12.2.
      12.2 === t2._t(getUA()) && C2("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
            ...
            case 0:
              return this.db ? [3, 2] : (k2("SimpleDb", "Opening database:", this.name), e = this, [4, new Promise(function(e2, r2) {
                ...
                i.onsuccess = function(t4) {
                  ...
                  "VersionError" === n2.name ? r2(new N2(S2.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : r2(new _r(t3, n2));
                ...
                return __generator(this, function(r) {
                  switch (r.label) {
                    ...
                    case 3:
                      ...
                      (r.sent(), u2), c2)];
                    case 4:
                      return h2 = r.sent(), f = "FirebaseError" !== h2.name && s < 3, k2("SimpleDb", "Transaction failed with error:", h2.message, "Retrying:", f), a.close(), f ? [3, 5] : [2, {
...
var Nr = (
  ...
  function() {
    ...
    return t2.prototype.put = function(t3, e) {
      var n;
      return void 0 !== e ? (k2("SimpleDb", "PUT", this.store.name, t3, e), n = this.store.put(e, t3)) : (k2("SimpleDb", "PUT", this.store.name, "<auto-key>", t3), n = this.store.put(t3)), Dr(n);
    }, /**
    ...
    t2.prototype.get = function(t3) {
      ...
      return Dr(this.store.get(t3)).next(function(n) {
        return void 0 === n && (n = null), k2("SimpleDb", "GET", e.store.name, t3, n), n;
      });
    }, t2.prototype.delete = function(t3) {
...
function kr(t2) {
  ...
  if (e >= 12.2 && e < 13) {
    ...
    if (t2.message.indexOf(n) >= 0) {
      ...
      return Ar || (Ar = true, // Throw a global exception outside of this promise chain, for the user to
      // potentially catch.
      setTimeout(function() {
        throw r;
      }, 0)), r;
...
var Or = (
  ...
  function() {
    function t2(t3, e, n, r, i, o, s) {
      void 0 === i && (i = j.min()), void 0 === o && (o = j.min()), void 0 === s && (s = X2.EMPTY_BYTE_STRING), this.target = t3, this.targetId = e, this.purpose = n, this.sequenceNumber = r, this.snapshotVersion = i, this.lastLimboFreeSnapshotVersion = o, this.resumeToken = s;
    }
...
function Fr(t2, e) {
  if (e.document) return Ln(t2.Lt, e.document, !!e.hasCommittedMutations);
  if (e.noDocument) {
...
function Kr(t2) {
  var e, n, r = Br(t2.readTime), i = void 0 !== t2.lastLimboFreeSnapshotVersion ? Br(t2.lastLimboFreeSnapshotVersion) : j.min();
  return void 0 !== t2.query.documents ? (O2(1 === (n = t2.query).documents.length), e = ee(Ht(kn(n.documents[0])))) : e = function(t3) {
    return ee(Vn(t3));
...
var ci = (
  ...
  function() {
    ...
    t2.prototype.ee = function(t3, e) {
      ...
      var n = li(t3), r = IDBKeyRange.bound(
        [e],
        [e + 1],
        /*lowerOpen=*/
        false,
      ...
      var n = $n(e.path), r = IDBKeyRange.bound(
        [n],
        [U2(n)],
        /*lowerOpen=*/
        false,
...
function di(t2) {
  return __awaiter(this, void 0, void 0, function() {
    return __generator(this, function(e) {
      if (t2.code !== S2.FAILED_PRECONDITION || t2.message !== mr) throw t2;
      return k2("LocalStore", "Unexpectedly lost primary lease"), [
        2
        /*return*/
      ];
    });
...
var mi = (
  ...
  function() {
    ...
    return t2.prototype.calculateTargetCount = function(t3, e) {
      ...
      var n = this;
      return -1 === this.params.cacheSizeCollectionThreshold ? (k2("LruGarbageCollector", "Garbage collection skipped; disabled"), br.resolve(Zr)) : this.getCacheSize(t3).next(function(r) {
    ...
    t2.prototype.we = function(t3, e) {
      ...
      return r.$t({
        ...
        0 === o ? (
          ...
          (i !== _.o && e(new at(Zn(n)), i), // set nextToReport to be this sequence number. It's the next one we
...
var Ii = (
  ...
  function() {
    ...
    t2.prototype.getEntry = function(t3, e) {
      ...
      return void 0 !== n ? br.resolve(n.document) : this.getFromCache(t3, e);
    }, /**
  ...
  function() {
    ...
    t2.prototype.Ee = function(t3, e) {
      ...
      return Si(t3).$t({
        ...
        for (var s = at.fromSegments(t4); o && at.comparator(o, s) < 0; ) n(o, null), o = i.getNext();
      ...
      if (n.isEqual(j.min())) {
        ...
        s.range = IDBKeyRange.lowerBound(
          ...
          /* open= */
          true
        ), s.index = ur.collectionReadTimeIndex;
      }
  ...
  function() {
    ...
    return t2.prototype.Rt = function(t3, e, n, r) {
      ...
      (0 !== n && (function(t4) {
        ...
        return function(t4) {
          var e2 = t4.store(fr.store), n2 = new fr(
            /*highestTargetId=*/
            0,
...
var Ci = (
  ...
  function() {
    function t2(e, n, r, i, o, s, u, a, c, h) {
      ...
      }, !t2.yt()) throw new N2(S2.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
      this.referenceDelegate = new gi(this, i), this.Le = n + "main", this.R = new Pr(a), this.Be = new Er(this.Le, 11, new Di(this.R)), this.qe = new ci(this.referenceDelegate, this.R), this.Ut = new Xr(), this.Ue = function(t3, e2) {
        return new Ei(t3, e2);
      }(this.R, this.Ut), this.Ke = new zr(), this.window && this.window.localStorage ? this.Qe = this.window.localStorage : (this.Qe = null, false === h && C2("IndexedDbPersistence", "LocalStorage is unavailable. As a result, persistence may not work reliably. In particular enablePersistence() could fail immediately after refreshing the page."));
    }
    ...
    t2.prototype.je = function() {
      ...
      return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", function(e) {
        ...
        return k2("IndexedDbPersistence", "Releasing owner lease after error during lease refresh", e), /* isPrimary= */
        false;
      }).then(function(e) {
    ...
    t2.prototype.fn = function() {
      ...
      return this.Be.runTransaction(t3, o, vr, function(o2) {
        return i = new Cr(o2, r.Ne ? r.Ne.next() : _.o), "readwrite-primary" === e ? r.Je(i).next(function(t4) {
          return !!t4 || r.Ye(i);
        }).next(function(e2) {
          if (!e2) throw C2("Failed to obtain primary lease for action '" + t3 + "'."), r.isPrimary = false, r.Se.enqueueRetryable(function() {
            return r.Me(false);
    ...
    t2.prototype.dn = function(t3) {
      var e = this;
      return xi(t3).get(er.key).next(function(t4) {
        if (null !== t4 && e.sn(t4.leaseTimestampMs, 5e3) && !e.cn(t4.ownerId) && !e.tn(t4) && !(e.Ce || e.allowTabSynchronization && t4.allowTabSynchronization)) throw new N2(S2.FAILED_PRECONDITION, ki);
      });
    }, /**
...
var Pi = (
  ...
  function() {
    ...
    t2.prototype.getDocumentsMatchingQuery = function(t3, e, n) {
      return function(t4) {
        return at.isDocumentKey(t4.path) && null === t4.collectionGroup && 0 === t4.filters.length;
      ...
      return this.Ue.getDocumentsMatchingQuery(t3, e, n).next(function(n2) {
        ...
        return i = e2, o.Rn(t3, i, r).next(function(t4) {
          ...
          for (var e3 = 0, n2 = i; e3 < n2.length; e3++) for (var o2 = n2[e3], s = 0, u = o2.mutations; s < u.length; s++) {
            ...
            (h = St.newInvalidDocument(c), r = r.insert(c, h)), Ce(a, h, o2.localWriteTime), h.isFoundDocument() || (r = r.remove(c));
          }
        });
      }).next(function() {
  ...
  function() {
    function t2(t3, e, n, r) {
      this.persistence = t3, this.xn = e, this.R = r, /**
           ...
           */
      this.Fn = new ze(V2), /** Maps a target to its targetID. */
      // TODO(wuandy): Evaluate if TargetId can be part of Target.
      this.kn = new bi(function(t4) {
        return At(t4);
      }, kt), /**
           ...
           */
      this.$n = j.min(), this._n = t3.getMutationQueue(n), this.On = t3.getRemoteDocumentCache(), this.qe = t3.getTargetCache(), this.Mn = new Pi(this.On, this._n, this.persistence.getIndexManager()), this.Ke = t3.getBundleCache(), this.xn.Vn(this.Mn);
    }
        ...
        case 0:
          return n = P2(t2), i = n._n, o = n.Mn, [4, n.persistence.runTransaction("Handle user change", "readonly", function(t3) {
            ...
            return n._n.getAllMutationBatches(t3).next(function(s2) {
              ...
              // MutationQueue.
              o = new Pi(n.On, i, n.persistence.getIndexManager()), i.getAllMutationBatches(t3);
            }).next(function(e2) {
    ...
    return function(t4, e2, n2, r2) {
      ...
      return o.forEach(function(t5) {
        s = s.next(function() {
          ...
          O2(null !== o2), e3.version.compareTo(o2) < 0 && (i2.applyToRemoteDocument(e3, n2), e3.isValidDocument() && // We use the commitVersion as the readTime rather than the
    ...
    e.targetChanges.forEach(function(e2, o2) {
      ...
      if (u2) {
        ...
        if (a2.approximateByteSize() > 0) {
          ...
          */
          function(t4, e3, n2) {
            return O2(e3.resumeToken.approximateByteSize() > 0), 0 === t4.resumeToken.approximateByteSize() || // Don't allow resume token changes to be buffered indefinitely. This
...
function Qi(t2, e, n, r, i) {
  ...
  return n.forEach(function(t3) {
    ...
    return n.forEach(function(n2, s) {
      ...
      ) : !u.isValidDocument() || s.version.compareTo(u.version) > 0 || 0 === s.version.compareTo(u.version) && u.hasPendingWrites ? (e.addEntry(s, a), o2 = o2.insert(n2, s)) : k2("LocalStore", "Ignoring outdated watch update for ", n2, ". Current version:", u.version, " Watch version:", s.version);
    }), o2;
  });
}
function Gi(t2, e) {
...
function zi(t2, e) {
  ...
  return n.persistence.runTransaction("Allocate target", "readwrite", function(t3) {
    ...
    return (null === r || t3.snapshotVersion.compareTo(r.snapshotVersion) > 0) && (n.Fn = n.Fn.insert(t3.targetId, t3), n.kn.set(e, t3.targetId)), t3;
  });
}
function Wi(t2, e, i) {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(r) {
      switch (r.label) {
        ...
        case 5:
          return n.Fn = n.Fn.remove(e), n.kn.delete(o.target), [
            2
            /*return*/
          ];
      }
...
function Hi(t2, e, n) {
  ...
  return r.persistence.runTransaction("Execute query", "readonly", function(t3) {
    return function(t4, e2, n2) {
      ...
      return void 0 !== i2 ? br.resolve(r2.Fn.get(i2)) : r2.qe.getTargetData(e2, n2);
...
function Ji(t2, e, i, o) {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(r) {
      switch (r.label) {
        case 0:
          for (n = P2(t2), s = on(), u = Je(), a = nn(), c = 0, h = i; c < h.length; c++) f = h[c], l2 = e.qn(f.metadata.name), f.document && (s = s.add(l2)), u = u.insert(l2, e.Un(f)), a = a.insert(l2, e.Kn(f.metadata.readTime));
...
function Zi(t2, e, i) {
  return void 0 === i && (i = on()), __awaiter(this, void 0, void 0, function() {
    var n, o;
    return __generator(this, function(r) {
      switch (r.label) {
        case 0:
...
var eo = (
  ...
  function() {
    function t2() {
      this.Wn = new Ye(no.Gn), // A set of outstanding references to a document sorted by target id.
...
var ro = (
  ...
  function() {
    ...
    return t2.prototype.checkEmpty = function(t3) {
      ...
      var n = this;
      O2(0 === this.hs(e.batchId, "removed")), this._n.shift();
      var r = this.rs;
...
var io = (
  ...
  function() {
    function t2(t3, e) {
      ...
      this.docs = new ze(at.comparator), /** Size of all cached documents. */
      this.size = 0;
    }
    return t2.prototype.addEntry = function(t3, e, n) {
  ...
  function() {
    function t2(t3) {
      this.persistence = t3, /**
           ...
           */
      this.ds = new bi(function(t4) {
        return At(t4);
      }, kt), /** The last received snapshot version. */
      this.lastRemoteSnapshotVersion = j.min(), /** The highest numbered target ID encountered. */
...
var co = (
  ...
  function() {
    function t2(t3) {
      ...
      this.As = new eo(), /** The list of documents that are potentially GCed after each transaction. */
      this.Rs = null;
    }
...
var yo = (
  ...
  function() {
    ...
    return t2.Vs = function(e, n, r) {
      ...
      return s && o.error && ((s = "string" == typeof o.error.message && "string" == typeof o.error.code) && (i = new N2(o.error.code, o.error.message))), s ? new t2(e, n, o.state, i) : (C2("SharedClientState", "Failed to parse mutation state for ID '" + n + "': " + r), null);
...
var vo = (
  ...
  function() {
    ...
    return t2.Vs = function(e, n) {
      ...
      return o && i.error && ((o = "string" == typeof i.error.message && "string" == typeof i.error.code) && (r = new N2(i.error.code, i.error.message))), o ? new t2(e, i.state, r) : (C2("SharedClientState", "Failed to parse target state for ID '" + e + "': " + n), null);
    }, t2.prototype.Ss = function() {
      var t3 = {
        state: this.state,
        updateTimeMs: Date.now()
...
var mo = (
  ...
  function() {
    ...
    return t2.Vs = function(e, n) {
      for (var r = JSON.parse(n), i = "object" == typeof r && r.activeTargetIds instanceof Array, o = un(), s = 0; i && s < r.activeTargetIds.length; ++s) i = ut(r.activeTargetIds[s]), o = o.add(r.activeTargetIds[s]);
...
var go = (
  ...
  function() {
    ...
    return t2.Vs = function(e) {
      var n = JSON.parse(e);
      return "object" == typeof n && -1 !== ["Unknown", "Online", "Offline"].indexOf(n.onlineState) && "string" == typeof n.clientId ? new t2(n.clientId, n.onlineState) : (C2("SharedClientState", "Failed to parse online state: " + e), null);
    }, t2;
  }()
);
var wo = (
...
var bo = (
  ...
  function() {
    function t2(t3, e, n, r, i) {
      this.window = t3, this.Se = e, this.persistenceKey = n, this.Ns = r, this.syncEngine = null, this.onlineStateHandler = null, this.sequenceNumberHandler = null, this.xs = this.Fs.bind(this), this.ks = new ze(V2), this.started = false, /**
           * Captures WebStorage events that occur before `start()` is called. These
           * events are replayed once `WebStorageSharedClientState` is started.
           */
      this.$s = [];
      var o = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
      this.storage = this.window.localStorage, this.currentUser = i, this.Os = fo(this.persistenceKey, this.Ns), this.Ms = /** Assembles the key for the current sequence number. */
      function(t4) {
        return "firestore_sequence_number_" + t4;
      }(this.persistenceKey), this.ks = this.ks.insert(this.Ns, new wo()), this.Ls = new RegExp("^firestore_clients_" + o + "_([^_]*)$"), this.Bs = new RegExp("^firestore_mutations_" + o + "_(\\d+)(?:_(.*))?$"), this.qs = new RegExp("^firestore_targets_" + o + "_(\\d+)$"), this.Us = /** Assembles the key for the online state of the primary tab. */
      function(t4) {
    ...
    return t2.yt = function(t3) {
      ...
      return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(r) {
          switch (r.label) {
            ...
            case 1:
              for (t3 = r.sent(), e = 0, n = t3; e < n.length; e++) (i = n[e]) !== this.Ns && (o = this.getItem(fo(this.persistenceKey, i))) && (s = mo.Vs(i, o)) && (this.ks = this.ks.insert(s.clientId, s));
              for (this.Qs(), (u = this.storage.getItem(this.Us)) && (a = this.js(u)) && this.Ws(a), c = 0, h = this.$s; c < h.length; c++) f = h[c], this.Fs(f);
      ...
      if (i.storageArea === this.storage) {
        if (k2("SharedClientState", "EVENT", i.key, i.newValue), i.key === this.Os) return void C2("Received WebStorage notification for local change. Another client might have garbage-collected our state");
    ...
    t2.prototype.js = function(t3) {
      ...
      return __awaiter(this, void 0, void 0, function() {
        return __generator(this, function(e) {
          return t3.user.uid === this.currentUser.uid ? [2, this.syncEngine.ui(t3.batchId, t3.state, t3.error)] : (k2("SharedClientState", "Ignoring mutation for non-active user " + t3.user.uid), [
            2
            /*return*/
          ]);
        });
...
var No = (
  ...
  function(e) {
    ...
    return __extends(n, e), n.prototype.ki = function(t2, e2, n2, r) {
            ...
            switch (s.getLastErrorCode()) {
              ...
              case ErrorCode.HTTP_ERROR:
                ...
                if (k2("Connection", 'RPC "' + t2 + '" failed with status:', n3, "response text:", s.getResponseText()), n3 > 0) {
                  ...
                  } else o(new N2(S2.UNKNOWN, "Server responded with status " + s.getStatus()));
                } else
      ...
      this.useFetchStreams && (f.xmlHttpFactory = new FetchXmlHttpFactory({})), this.Fi(f.initMessageHeaders, e2), // Sending the custom headers we just added to request.initMessageHeaders
          ...
          if (i2) {
            ...
            var o = i2.status, s = (
              ...
              */
              function(t4) {
                var e4 = qe[t4];
                if (void 0 !== e4) return Ge(e4);
              }(o)
            ), u = i2.message;
            void 0 === s && (s = S2.INTERNAL, u = "Unknown error status: " + o + " with message " + i2.message), // Mark closed so no further events are propagated
            y2 = true, v2.Vi(new N2(s, u)), d2.close();
          } else k2("Connection", "WebChannel received:", n3), v2.Si(n3);
        }
    ...
    function() {
      ...
      t2.prototype.Fi = function(t3, e) {
        if (t3["X-Goog-Api-Client"] = "gl-js/ fire/8.7.0", // Content-Type: text/plain will avoid preflight requests which might
  ...
  function() {
    function t2(t3, e, n, r, i, o) {
      this.Se = t3, this.zi = n, this.Hi = r, this.Ji = i, this.listener = o, this.state = 0, /**
           ...
           * close.
           */
      this.Yi = 0, this.Xi = null, this.stream = null, this.Zi = new Co(t3, e);
    }
          ...
          switch (n.label) {
            case 0:
              ...
              this.Yi++, 3 !== t3 ? (
                ...
                (C2(e.toString()), C2("Using maximum backoff delay to prevent overloading the backend."), this.Zi.Qi())
    ...
    return __extends(n, e), n.prototype.wr = function(t2) {
      ...
      var e2 = function(t3, e3) {
        ...
        if ("targetChange" in e3) {
          e3.targetChange;
          var r = function(t4) {
            return "NO_CHANGE" === t4 ? 0 : "ADD" === t4 ? 1 : "REMOVE" === t4 ? 2 : "CURRENT" === t4 ? 3 : "RESET" === t4 ? 4 : L2();
          }(e3.targetChange.targetChangeType || "NO_CHANGE"), i = e3.targetChange.targetIds || [], o = function(t4, e4) {
            return t4.I ? (O2(void 0 === e4 || "string" == typeof e4), X2.fromBase64String(e4 || "")) : (O2(void 0 === e4 || e4 instanceof Uint8Array), X2.fromUint8Array(e4 || new Uint8Array()));
          }(t3, e3.targetChange.resumeToken), s = (u = e3.targetChange.cause) && function(t4) {
            var e4 = void 0 === t4.code ? S2.UNKNOWN : Ge(t4.code);
        ...
        } else if ("documentDelete" in e3) e3.documentDelete, (r = e3.documentDelete).document, i = Dn(t3, r.document), o = r.readTime ? Tn(r.readTime) : j.min(), u = St.newNoDocument(i, o), s = r.removedTargetIds || [], n3 = new hn([], s, u.key, u);
        else if ("documentRemove" in e3) e3.documentRemove, (r = e3.documentRemove).document, i = Dn(t3, r.document), o = r.removedTargetIds || [], n3 = new hn([], o, i, null);
        else {
          if (!("filter" in e3)) return L2();
          e3.filter;
          var h = e3.filter;
        ...
        if (!("targetChange" in t3)) return j.min();
    ...
    n.prototype.mr = function(t2) {
      ...
      e2.database = Cn(this.R), e2.addTarget = function(t3, e3) {
        ...
        return (n3 = Ct(r) ? {
          ...
          query: Mn(t3, r)
        }).targetId = e3.targetId, e3.resumeToken.approximateByteSize() > 0 ? n3.resumeToken = In(t3, e3.resumeToken) : e3.snapshotVersion.compareTo(j.min()) > 0 && // TODO(wuandy): Consider removing above check because it is most likely true.
        // Right now, many tests depend on this behaviour though (leaving min() out
        // of serialization).
        (n3.readTime = bn(t3, e3.snapshotVersion.toTimestamp())), n3;
      }(this.R, t2);
  ...
  function(e) {
    ...
    n.prototype.start = function() {
      ...
      if (
        ...
        O2(!!t2.streamToken), this.lastStreamToken = t2.streamToken, this.gr
      ) {
        this.Zi.reset();
        var e2 = function(t3, e3) {
          return t3 && t3.length > 0 ? (O2(void 0 !== e3), t3.map(function(t4) {
            return function(t5, e4) {
              var n3 = t5.updateTime ? Tn(t5.updateTime) : Tn(e4);
              return n3.isEqual(j.min()) && // The Firestore Emulator currently returns an update time of 0 for
              // deletes of non-existing documents (rather than null). This breaks the
              // test "get deleted doc while offline with source=cache" as NoDocuments
              // with version 0 are filtered by IndexedDb's RemoteDocumentCache.
              // TODO(#2149): Remove this when Emulator is fixed
              (n3 = Tn(e4)), new Se(n3, t5.transformResults || []);
            }(t4, e3);
          })) : [];
        }(t2.writeResults, t2.commitTime), n2 = Tn(t2.commitTime);
        return this.listener.Tr(n2, e2);
      }
      return O2(!t2.writeResults || 0 === t2.writeResults.length), this.gr = true, this.listener.Ir();
    }, /**
...
var Oo = (
  ...
  function(e) {
    ...
    return __extends(n, e), n.prototype.br = function() {
      if (this.Rr) throw new N2(S2.FAILED_PRECONDITION, "The client has already been terminated.");
    ...
    n.prototype.Ni = function(t2, e2, n2) {
      ...
      return this.br(), this.credentials.getToken().then(function(i) {
        ...
        throw "FirebaseError" === t3.name ? (t3.code === S2.UNAUTHENTICATED && r.credentials.invalidateToken(), t3) : new N2(S2.UNKNOWN, t3.toString());
      });
...
function Uo(t2, e) {
  var n = P2(t2), r = ss(n);
  n.$r.delete(e), r.er() && jo(n, e), 0 === n.$r.size && (r.er() ? r.ir() : Go(n) && // Revert to OnlineState.Unknown if the watch stream is not open and we
...
function Ho(t2, e) {
  return __awaiter(this, void 0, void 0, function() {
    return __generator(this, function(n) {
      return zo(t2), // If we still need the watch stream, retry the connection.
      Qo(t2) ? (t2.Br.Nr(e), Ko(t2)) : (
      ...
      switch (a.label) {
        case 0:
          if (t2.Br.set(
            "Online"
            /* Online */
          ), !(e instanceof ln && 2 === e.state && e.cause))
            return [3, 6];
          a.label = 1;
        case 1:
        ...
        case 5:
          return [3, 13];
        case 6:
          if (e instanceof hn ? t2.qr.X(e) : e instanceof fn ? t2.qr.rt(e) : t2.qr.et(e), i.isEqual(j.min())) return [3, 13];
          a.label = 7;
        case 7:
          ...
          return s = a.sent(), i.compareTo(s) >= 0 ? [
            ...
            function(t3, e2) {
              ...
              n.targetMismatches.forEach(function(e3) {
                var n2 = t3.$r.get(e3);
                if (n2) {
                  t3.$r.set(e3, n2.withResumeToken(X2.EMPTY_BYTE_STRING, n2.snapshotVersion)), // Cause a hard reset by unwatching and rewatching immediately, but
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(r) {
      switch (r.label) {
        ...
        case 3:
          return null === (o = r.sent()) ? (0 === e.kr.length && n.ir(), [3, 7]) : (i = o.batchId, function(t3, e2) {
            t3.kr.push(e2);
            var n2 = us(t3);
...
function ns(t2) {
  return __awaiter(this, void 0, void 0, function() {
    var e, n, i, o;
    return __generator(this, function(r) {
      for (e = us(t2), n = 0, i = t2.kr; n < i.length; n++) o = i[n], e.Er(o.mutations);
      return [
        2
        /*return*/
      ];
          ...
          return e && us(t2).pr ? [4, function(t3, e2) {
            return __awaiter(this, void 0, void 0, function() {
              ...
              return __generator(this, function(r) {
                switch (r.label) {
                  case 0:
                    return Qe(i2 = e2.code) && i2 !== S2.ABORTED ? (n = t3.kr.shift(), // In this case it's also unlikely that the server itself is melting
                    // down -- this was just a bad request so inhibit backoff on the next
                    // restart.
                    us(t3).sr(), [4, Xo(t3, function() {
  ...
  (t2.Ur = function(t3, e2, n) {
    ...
    return __awaiter(e, void 0, void 0, function() {
      return __generator(this, function(e2) {
        switch (e2.label) {
          case 0:
            return i ? (t2.Ur.sr(), Qo(t2) ? Ko(t2) : t2.Br.set(
              "Unknown"
              /* Unknown */
            ), [3, 3]) : [3, 1];
          case 1:
...
var as = (
  ...
  function() {
    function t2(t3, e, n, r, i) {
      this.asyncQueue = t3, this.timerId = e, this.targetTimeMs = n, this.op = r, this.removalCallback = i, this.deferred = new wr(), this.then = this.deferred.promise.then.bind(this.deferred.promise), // It's normal for the deferred promise to be canceled (due to cancellation)
    ...
    t2.prototype.cancel = function(t3) {
      null !== this.timerHandle && (this.clearTimeout(), this.deferred.reject(new N2(S2.CANCELLED, "Operation cancelled" + (t3 ? ": " + t3 : ""))));
...
function cs(t2, e) {
  if (C2("AsyncQueue", e + ": " + t2), Sr(t2)) return new N2(S2.UNAVAILABLE, e + ": " + t2);
  throw t2;
}
var hs = (
  /** @class */
...
var ls = (
  ...
  function() {
    ...
    return t2.fromInitialDocuments = function(e, n, r, i) {
      ...
      if (!(this.fromCache === t3.fromCache && this.syncStateChanged === t3.syncStateChanged && this.mutatedKeys.isEqual(t3.mutatedKeys) && re(this.query, t3.query) && this.docs.isEqual(t3.docs) && this.oldDocs.isEqual(t3.oldDocs))) return false;
...
var ps = function() {
  this.queries = new bi(function(t2) {
    return ie(t2);
  }, re), this.onlineState = "Unknown", this.Gr = /* @__PURE__ */ new Set();
};
function ys(t2, e) {
  return __awaiter(this, void 0, void 0, function() {
    var n, i, o, s, u, a, c;
    return __generator(this, function(r) {
      switch (r.label) {
        case 0:
          if (n = P2(t2), i = e.query, o = false, (s = n.queries.get(i)) || (o = true, s = new ds()), !o) return [3, 4];
          r.label = 1;
        case 1:
        ...
        case 4:
          ...
          e.zr(n.onlineState), s.Wr && e.Hr(s.Wr) && ws(n), [
            2
            /*return*/
          ];
      }
...
function vs(t2, e) {
  return __awaiter(this, void 0, void 0, function() {
    var n, i, o, s, u;
    return __generator(this, function(r) {
      return n = P2(t2), i = e.query, o = false, (s = n.queries.get(i)) && (u = s.listeners.indexOf(e)) >= 0 && (s.listeners.splice(u, 1), o = 0 === s.listeners.length), o ? [2, (n.queries.delete(i), n.onUnlisten(i))] : [
        2
        /*return*/
      ];
    });
...
var Ts = (
  ...
  function() {
    function t2(t3, e, n) {
      ...
      this.documents = [], this.progress = _s(t3);
    }
    return t2.prototype.oo = function(t3) {
      ...
      for (var e = /* @__PURE__ */ new Map(), n = new Es(this.R), r = 0, i = t3; r < i.length; r++) {
        var o = i[r];
...
var Ds = (
  ...
  function() {
    function t2(t3, e) {
      ...
      this.ho = on(), /** Document Keys that have local changes */
      this.mutatedKeys = on(), this.lo = ue(t3), this.fo = new hs(this.lo);
    }
    ...
    t2.prototype._o = function(t3, e) {
      ...
      if (t3.inorderTraversal(function(t4, e2) {
        var h2 = i.get(t4), f = se(n.query, e2) ? e2 : null, l2 = !!h2 && n.mutatedKeys.has(h2.key), d2 = !!f && (f.hasLocalMutations || // We only consider committed mutations for documents that were
        ...
        (u = true)), p2 && (f ? (s = s.add(f), o = d2 ? o.add(t4) : o.delete(t4)) : (s = s.delete(t4), o = o.delete(t4)));
    ...
    t2.prototype.Ro = function() {
      return ls.fromInitialDocuments(this.query, this.fo, this.mutatedKeys, 0 === this.ao);
    }, t2;
  }()
);
  ...
  function() {
    function t2(t3, e, n, r, i, o) {
      ...
      this.Do = new ze(at.comparator), /**
           ...
           */
      this.Co = /* @__PURE__ */ new Map(), this.No = new eo(), /** Stores user completion handlers, indexed by User and BatchId. */
      this.xo = {}, /** Stores user callbacks waiting for all pending writes to be acknowledged. */
      this.Fo = /* @__PURE__ */ new Map(), this.ko = ai.Yt(), this.onlineState = "Unknown", // The primary state is set to `true` or `false` immediately after Firestore
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(r) {
      switch (r.label) {
        ...
        case 2:
          return u = r.sent(), a = n.sharedClientState.addLocalQueryTarget(u.targetId), i = u.targetId, [4, Rs(n, e, i, "current" === a)];
        case 3:
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(l2) {
      switch (l2.label) {
            ...
            return function(t3, e3, i3, o3) {
              return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(r) {
                  switch (r.label) {
                    case 0:
                      return n = e3.view._o(i3), n.Nn ? [4, Hi(
                        t3.localStore,
                        e3.query,
                        /* usePreviousResults= */
                        false
                    ...
                    case 2:
                      return s2 = o3 && o3.targetChanges.get(e3.targetId), u2 = e3.view.applyChanges(
                        ...
                        t3.isPrimaryClient,
                        s2
                      ), [2, (Gs(t3, e3.targetId, u2.To), u2.snapshot)];
                  }
                });
              });
            }(t2, e2, i2, o2);
        ...
        case 1:
          return s = l2.sent(), u = new Ds(e, s.Bn), a = u._o(s.documents), c = cn.createSynthesizedTargetChangeForCurrentChange(i, o && "Offline" !== t2.onlineState), h = u.applyChanges(
            a,
            /* updateLimboDocuments= */
            t2.isPrimaryClient,
            c
          ), Gs(t2, i, h.To), f = new As(e, i, u), [2, (t2.Po.set(e, f), t2.Vo.has(i) ? t2.Vo.get(i).push(e) : t2.Vo.set(i, [e]), h.snapshot)];
      }
    });
  });
}
      ...
      switch (r.label) {
        case 0:
          return n = P2(t2), i = n.Po.get(e), (o = n.Vo.get(i.targetId)).length > 1 ? [2, (n.Vo.set(i.targetId, o.filter(function(t3) {
            ...
            (n.sharedClientState.removeLocalQueryTarget(i.targetId), n.sharedClientState.isActiveQueryTarget(i.targetId) ? [3, 2] : [4, Wi(
              n.localStore,
              i.targetId,
            ...
            return r2.persistence.runTransaction("Locally write mutations", "readwrite", function(t4) {
              return r2.Mn.pn(t4, o2).next(function(o3) {
                ...
                for (var s2 = [], u2 = 0, a = e2; u2 < a.length; u2++) {
                  ...
                  // exists=true
                  s2.push(new Pe(c.key, h, _t(h.value.mapValue), Ne.exists(true)));
                }
      ...
      switch (r.label) {
        ...
        case 2:
          ...
          e.targetChanges.forEach(function(t3, e2) {
            ...
            (O2(t3.addedDocuments.size + t3.modifiedDocuments.size + t3.removedDocuments.size <= 1), t3.addedDocuments.size > 0 ? r2.bo = true : t3.modifiedDocuments.size > 0 ? O2(r2.bo) : t3.removedDocuments.size > 0 && (O2(r2.bo), r2.bo = false));
          }), [4, Hs(n, i, e)];
        case 3:
          return r.sent(), [3, 6];
        case 4:
...
function Ms(t2, e, i) {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(r) {
      switch (r.label) {
        case 0:
          return (n = P2(t2)).sharedClientState.updateQueryState(e, "rejected", i), o = n.Co.get(e), (s = o && o.key) ? (u = (u = new ze(at.comparator)).insert(s, St.newNoDocument(s, j.min())), a = on().add(s), c = new an(
            j.min(),
            /* targetChanges= */
            /* @__PURE__ */ new Map(),
            /* targetMismatches= */
        ...
        case 1:
          ...
          n.Do = n.Do.remove(s), n.Co.delete(e), Ws(n), [3, 4];
        case 2:
          return [4, Wi(
            n.localStore,
            e,
      ...
      switch (r.label) {
        ...
        case 2:
          ...
          js(
            ...
            /*error=*/
            null
          ), Bs(n, i), n.sharedClientState.updateMutationState(i, "acknowledged"), [4, Hs(n, o)];
        case 3:
          return r.sent(), [3, 6];
        case 4:
          return [4, di(r.sent())];
    ...
    return __generator(this, function(r) {
      switch (r.label) {
          ...
          return r.trys.push([1, 4, , 6]), [4, function(t3, e2) {
            ...
            return n2.persistence.runTransaction("Reject batch", "readwrite-primary", function(t4) {
              ...
              return n2._n.lookupMutationBatch(t4, e2).next(function(e3) {
                return O2(null !== e3), r2 = e3.keys(), n2._n.removeMutationBatch(t4, e3);
              }).next(function() {
        ...
        case 2:
          ...
          // listen events.
          js(n, e, i), Bs(n, e), n.sharedClientState.updateMutationState(e, "rejected", i), [4, Hs(n, o)];
        case 3:
          return r.sent(), [3, 6];
        case 4:
          return [4, di(r.sent())];
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(r) {
      switch (r.label) {
        ...
        case 2:
          return -1 === (i = r.sent()) ? [2, void e.resolve()] : ((o = n.Fo.get(i) || []).push(e), n.Fo.set(i, o), [3, 4]);
        case 3:
...
function Qs(t2, e) {
  ...
  var n = t2.Do.get(e);
  null !== n && (Uo(t2.remoteStore, n), t2.Do = t2.Do.remove(e), t2.Co.delete(n), Ws(t2));
}
function Gs(t2, e, n) {
  for (var r = 0, i = n; r < i.length; r++) {
    var o = i[r];
    o instanceof Ss ? (t2.No.addReference(o.key, e), zs(t2, o)) : o instanceof Ns ? (k2("SyncEngine", "Document no longer in limbo: " + o.key), t2.No.removeReference(o.key, e), t2.No.containsKey(o.key) || // We removed the last reference for this key
    Qs(t2, o.key)) : L2();
  }
}
function zs(t2, e) {
              ...
              return __generator(this, function(r) {
                switch (r.label) {
                  ...
                  case 2:
                    return r.sent(), [3, 4];
                  case 3:
                    if (!Sr(i2 = r.sent())) throw i2;
                    return k2("LocalStore", "Failed to update sequence numbers: " + i2), [3, 4];
                  case 4:
                    for (o2 = 0, s2 = e2; o2 < s2.length; o2++) u2 = s2[o2], a2 = u2.targetId, u2.fromCache || (c2 = n.Fn.get(a2), h = c2.snapshotVersion, f = c2.withLastLimboFreeSnapshotVersion(h), // Advance the last limbo free snapshot version
                    n.Fn = n.Fn.insert(a2, f));
                    return [
                      2
                      /*return*/
                    ];
    ...
    return __generator(this, function(r) {
      switch (r.label) {
        ...
        case 1:
          ...
          n.sharedClientState.handleUserChange(e, i.removedBatchIds, i.addedBatchIds), [4, Hs(n, i.Ln)];
        case 2:
          r.sent(), r.label = 3;
        case 3:
          return [
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(r) {
      switch (r.label) {
        ...
        case 1:
          return null === (s = r.sent()) ? [3, 6] : "pending" !== i ? [3, 3] : [4, Jo(n.remoteStore)];
        case 2:
          return r.sent(), [3, 4];
        case 3:
          "acknowledged" === i || "rejected" === i ? (
            ...
            // other clients.
            (js(n, e, o || null), Bs(n, e), function(t3, e2) {
              P2(P2(t3)._n).Gt(e2);
            }(n.localStore, e))
          ) : L2(), r.label = 4;
        case 4:
...
function tu(t2, e) {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(r) {
      switch (r.label) {
        case 0:
          return su(n = P2(t2)), uu(n), true !== e || true === n.$o ? [3, 3] : (i = n.sharedClientState.getAllActiveQueryTargets(), [4, eu(n, i.toArray())]);
        case 1:
        ...
        case 5:
          ...
          function(t3) {
            ...
            }), e2.No.ts(), e2.Co = /* @__PURE__ */ new Map(), e2.Do = new ze(at.comparator);
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(r) {
      switch (r.label) {
        ...
        case 1:
          return s < u.length ? (a = u[s], c = void 0, (h = n.Vo.get(a)) && 0 !== h.length ? [4, zi(n.localStore, ee(h[0]))] : [3, 7]) : [3, 13];
        case 2:
      ...
      switch (r.label) {
        case 0:
          return (n = P2(t2)).$o ? (
            ...
            (k2("SyncEngine", "Ignoring unexpected query state notification."), [3, 8])
          ) : [3, 1];
        case 1:
        ...
        case 3:
          return s = r.sent(), u = an.createSynthesizedRemoteEventForCurrentChange(e, "current" === i), [4, Hs(n, s, u)];
        case 4:
          return r.sent(), [3, 8];
        case 5:
          return [4, Wi(
...
function ou(t2, e, i) {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(p2) {
      switch (p2.label) {
        case 0:
          if (!(n = su(t2)).$o) return [3, 10];
          o = 0, s = e, p2.label = 1;
        case 1:
          return o < s.length ? (u = s[o], n.Vo.has(u) ? (
            // A target might have been added in a previous attempt
            (k2("SyncEngine", "Adding an already active target " + u), [3, 5])
          ) : [4, Yi(n.localStore, u)]) : [3, 6];
        case 2:
          return a = p2.sent(), [4, zi(n.localStore, a)];
        case 3:
          return c = p2.sent(), [4, Rs(
            n,
            nu(a),
            c.targetId,
            /*current=*/
...
var hu = (
  ...
  function(e) {
    ...
    return __extends(i, e), i.prototype.initialize = function(t2) {
      ...
      var e2 = Li(t2.databaseInfo.databaseId, t2.databaseInfo.persistenceKey), n = void 0 !== this.cacheSizeBytes ? ti.withCacheSize(this.cacheSizeBytes) : ti.DEFAULT;
...
var fu = (
  ...
  function(e) {
    ...
    return __extends(i, e), i.prototype.initialize = function(t2) {
      ...
      var e2 = Do();
      if (!bo.yt(e2)) throw new N2(S2.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
      ...
      return function(t3) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(n) {
            switch (n.label) {
              case 0:
                return e = P2(t3), k2("RemoteStore", "RemoteStore shutting down."), e.Or.add(
                  5
                  /* Shutdown */
                ), [4, Vo(e)];
              case 1:
    ...
    return t2.prototype.lookup = function(t3) {
      return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(o) {
          switch (o.label) {
            case 0:
              if (this.ensureCommitNotCalled(), this.mutations.length > 0) throw new N2(S2.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
...
var mu = (
  ...
  function() {
    function t2(t3, e, n, r) {
      this.asyncQueue = t3, this.datastore = e, this.updateFunction = n, this.deferred = r, this.ec = 5, this.Zi = new Co(
        this.asyncQueue,
        "transaction_retry"
        /* TransactionRetry */
      );
...
var gu = (
  ...
  function() {
    ...
    t2.prototype.verifyNotTerminated = function() {
      if (this.asyncQueue.isShuttingDown) throw new N2(S2.FAILED_PRECONDITION, "The client has already been terminated.");
    }, t2.prototype.terminate = function() {
      var t3 = this;
            ...
            return function(t4, e2) {
              return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(r) {
                  switch (r.label) {
                    case 0:
                      return (n = P2(t4)).asyncQueue.verifyOperationInProgress(), k2("RemoteStore", "RemoteStore received new credentials"), i2 = Go(n), // Tear down and re-create our network streams. This will ensure we get a
              ...
              var o2 = new pu({
                next: function(o3) {
                  ...
                  !u && o3.fromCache ? (
                    ...
                    i2.reject(new N2(S2.UNAVAILABLE, "Failed to get document because the client is offline."))
                  ) : u && o3.fromCache && r2 && "server" === r2.source ? i2.reject(new N2(S2.UNAVAILABLE, 'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')) : i2.resolve(o3);
                },
                error: function(t4) {
                  return i2.reject(t4);
                }
            ...
            return n = function(t3, e2, n2, r2, i2) {
              var o2 = new pu({
                next: function(n3) {
                  e2.enqueueAndForget(function() {
                    return vs(t3, s2);
                  }), n3.fromCache && "server" === r2.source ? i2.reject(new N2(S2.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i2.resolve(n3);
                },
                error: function(t4) {
                  return i2.reject(t4);
                }
...
var Fu = (
  ...
  function() {
    function t2(t3) {
      var e = this;
      this.currentUser = ho.UNAUTHENTICATED, /** Promise that allows blocking on the initialization of Firebase Auth. */
      this.oc = new wr(), /**
      ...
      setTimeout(function() {
        if (!e.auth) {
          ...
          r ? n(r) : (
            ...
            (k2("FirebaseCredentialsProvider", "Auth not yet detected"), e.oc.resolve())
          );
        }
      }, 0);
    }
    return t2.prototype.getToken = function() {
      ...
      return this.forceRefresh = false, this.auth ? this.auth.getToken(n).then(function(n2) {
        return t3.cc !== e ? (k2("FirebaseCredentialsProvider", "getToken aborted due to token change."), t3.getToken()) : n2 ? (O2("string" == typeof n2.accessToken), new Lu(n2.accessToken, t3.currentUser)) : null;
    ...
    t2.prototype.ac = function() {
      ...
      return O2(null === t3 || "string" == typeof t3), new ho(t3);
    }, t2;
  }()
);
var Mu = (
...
function qu(t2, e, n) {
  if (!n) throw new N2(S2.INVALID_ARGUMENT, "Function " + t2 + "() cannot be called with an empty " + e + ".");
}
function Uu(t2, e) {
  if (void 0 === e) return {
    merge: false
  };
  if (void 0 !== e.mergeFields && void 0 !== e.merge) throw new N2(S2.INVALID_ARGUMENT, "Invalid options passed to function " + t2 + '(): You cannot specify both "merge" and "mergeFields".');
  return e;
}
function Bu(t2, e, n, r) {
  if (true === e && true === r) throw new N2(S2.INVALID_ARGUMENT, t2 + " and " + n + " cannot be used together.");
}
function ju(t2) {
  if (!at.isDocumentKey(t2)) throw new N2(S2.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + t2 + " has " + t2.length + ".");
}
function Ku(t2) {
  if (at.isDocumentKey(t2)) throw new N2(S2.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t2 + " has " + t2.length + ".");
}
function Qu(t2) {
...
function Gu(t2, e) {
  ...
  (t2 = t2._delegate), !(t2 instanceof e)) {
    if (e.name === t2.constructor.name) throw new N2(S2.INVALID_ARGUMENT, "Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");
    var n = Qu(t2);
...
function zu(t2, e) {
  if (e <= 0) throw new N2(S2.INVALID_ARGUMENT, "Function " + t2 + "() requires a positive number, but it was: " + e + ".");
}
var Wu = (
  /** @class */
  function() {
    function t2(t3) {
      var e;
      if (void 0 === t3.host) {
        if (void 0 !== t3.ssl) throw new N2(S2.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
      ...
      if (this.credentials = t3.credentials, this.ignoreUndefinedProperties = !!t3.ignoreUndefinedProperties, void 0 === t3.cacheSizeBytes) this.cacheSizeBytes = 41943040;
        ...
        if (-1 !== t3.cacheSizeBytes && t3.cacheSizeBytes < 1048576) throw new N2(S2.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
  ...
  function() {
    function t2(t3, e) {
      this.type = "firestore-lite", this._persistenceKey = "(lite)", this._settings = new Wu({}), this._settingsFrozen = false, t3 instanceof xu ? (this._databaseId = t3, this._credentials = new Ou()) : (this._app = t3, this._databaseId = function(t4) {
        if (!Object.prototype.hasOwnProperty.apply(t4.options, ["projectId"])) throw new N2(S2.INVALID_ARGUMENT, '"projectId" not provided in firebase.initializeApp.');
    ...
    return Object.defineProperty(t2.prototype, "app", {
       ...
       */
      get: function() {
        if (!this._app) throw new N2(S2.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
        return this._app;
      },
      enumerable: false,
      configurable: true
      ...
      if (this._settingsFrozen) throw new N2(S2.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");
      this._settings = new Wu(t3), void 0 !== t3.credentials && (this._credentials = function(t4) {
        if (!t4) return new Ou();
        switch (t4.type) {
          case "gapi":
            var e = t4.client;
            return O2(!("object" != typeof e || null === e || !e.auth || !e.auth.getAuthHeaderValueForFirstParty)), new Vu(e, t4.sessionIndex || "0", t4.iamToken || null);
          case "provider":
            return t4.client;
          default:
...
var Xu = (
  ...
  function(e) {
    function n(t2, n2, r) {
      var i = this;
      return (i = e.call(this, t2, n2, Ht(r)) || this)._path = r, /** The type of this Firestore reference. */
      i.type = "collection", i;
    }
...
function Ju(t2, n) {
  ...
  if (t2 = getModularInstance(t2), qu("collection", "path", n), t2 instanceof Hu) return Ku(r = W2.fromString.apply(W2, __spreadArray([n], i))), new Xu(
    t2,
    /* converter= */
    null,
    r
  );
  if (!(t2 instanceof Yu || t2 instanceof Xu)) throw new N2(S2.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
  return Ku(r = W2.fromString.apply(W2, __spreadArray([t2.path], i)).child(W2.fromString(n))), new Xu(
    t2.firestore,
    /* converter= */
    null,
    r
...
function Zu(t2, n) {
  ...
  // 'undefined' and 'null'.
  1 === arguments.length && (n = M2.u()), qu("doc", "path", n), t2 instanceof Hu) return ju(r = W2.fromString.apply(W2, __spreadArray([n], i))), new Yu(
    t2,
    /* converter= */
    null,
    new at(r)
  ...
  function() {
    ...
    t2.prototype.enqueueAndForget = function(t3) {
      ...
      if (!this._c) {
        this._c = true;
        var t3 = Ao();
        t3 && "function" == typeof t3.removeEventListener && t3.removeEventListener("visibilitychange", this.Tc);
      }
...
var sa2 = (
  ...
  function(e) {
    ...
    return __extends(n, e), n.prototype._terminate = function() {
      ...
      aa2(this), this._firestoreClient.terminate();
    }, n;
  }(Hu)
);
function ua2(t2) {
      ...
      return __generator(this, function(r) {
        switch (r.label) {
          ...
          case 3:
            ...
            */
            function(t3) {
              return "FirebaseError" === t3.name ? t3.code === S2.FAILED_PRECONDITION || t3.code === S2.UNIMPLEMENTED : !("undefined" != typeof DOMException && t3 instanceof DOMException) || (22 === t3.code || 20 === t3.code || // Firefox Private Browsing mode disables IndexedDb and returns
...
function ha2(t2) {
  if (t2._initialized || t2._terminated) throw new N2(S2.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only enable persistence before calling any other methods on a Firestore object.");
}
var fa2 = (
  /** @class */
  function() {
    function t2() {
      ...
      for (var n = 0; n < t3.length; ++n) if (0 === t3[n].length) throw new N2(S2.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
...
var pa2 = (
  ...
  function() {
    function t2(t3, e) {
      if (!isFinite(t3) || t3 < -90 || t3 > 90) throw new N2(S2.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + t3);
      if (!isFinite(e) || e < -180 || e > 180) throw new N2(S2.INVALID_ARGUMENT, "Longitude must be a number between -180 and 180, but was: " + e);
...
var va = (
  ...
  function() {
    ...
    return t2.prototype.toMutation = function(t3, e) {
      return null !== this.fieldMask ? new Pe(t3, this.data, this.fieldMask, e, this.fieldTransforms) : new Oe(t3, this.data, e, this.fieldTransforms);
    }, t2;
  }()
);
var ma2 = (
...
var wa = (
  ...
  function() {
    ...
    t2.prototype.Nc = function(e) {
      ...
      var e, n = null === (e = this.path) || void 0 === e ? void 0 : e.child(t3), r = this.Nc({
        path: n,
        Fc: false
      });
      return r.kc(t3), r;
    ...
    t2.prototype.contains = function(t3) {
      ...
      if (this.path) for (var t3 = 0; t3 < this.path.length; t3++) this.kc(this.path.get(t3));
    }, t2.prototype.kc = function(t3) {
      if (0 === t3.length) throw this.Mc("Document fields must not be empty");
      if (ga(this.Cc) && ya2.test(t3)) throw this.Mc('Document fields cannot begin and end with "__"');
    }, t2;
  }()
);
var ba2 = (
  ...
  function() {
    ...
    return t2.prototype.qc = function(t3, e, n, r) {
      return void 0 === r && (r = false), new wa({
        Cc: t3,
        methodName: e,
        Bc: n,
        path: Y2.emptyPath(),
...
function Ea(t2, e, n, r, i, o) {
  ...
  var u, a, c = La2(r, s);
  if (o.merge) u = new $(s.fieldMask), a = s.fieldTransforms;
  else if (o.mergeFields) {
    for (var h = [], f = 0, l2 = o.mergeFields; f < l2.length; f++) {
      var d2 = Fa2(e, l2[f], n);
      if (!s.contains(d2)) throw new N2(S2.INVALID_ARGUMENT, "Field '" + d2 + "' is specified in your field mask but missing from your input data.");
      Ua2(h, d2) || h.push(d2);
    }
...
var Ta = (
  ...
  function(e) {
    ...
    return __extends(n, e), n.prototype._toFieldTransform = function(t2) {
      if (2 !== t2.Cc) throw 1 === t2.Cc ? t2.Mc(this._methodName + "() can only appear at the top level of your update data") : t2.Mc(this._methodName + "() cannot be used with set() unless you pass {merge:true}");
...
function Ca2(t2, e, n, r, i, o) {
  ...
  if (o.length % 2 != 0) throw new N2(S2.INVALID_ARGUMENT, "Function " + e + "() needs to be called with an even number of arguments that alternate between field names and values.");
  for (var c = 0; c < o.length; c += 2) u.push(Fa2(e, o[c])), a.push(o[c + 1]);
  for (var h = [], l2 = Tt.empty(), d2 = u.length - 1; d2 >= 0; --d2) if (!Ua2(h, u[d2])) {
    var p2 = u[d2], y2 = a[d2];
...
function xa2(t2, e, n, r) {
  return void 0 === r && (r = false), Ra2(n, t2.qc(r ? 4 : 3, e));
}
function Ra2(t2, e) {
  if (Oa(
  ...
  if (t2 instanceof da2)
    return function(t3, e2) {
      if (!ga(e2.Cc)) throw e2.Mc(t3._methodName + "() can only be used with update() and set()");
      if (!e2.path) throw e2.Mc(t3._methodName + "() is not currently supported inside arrays");
  ...
  if (
    ...
    if (e.settings.Fc && 4 !== e.Cc) throw e.Mc("Nested arrays are not supported");
    return function(t3, e2) {
  ...
  return function(t3, e2) {
    ...
    if ("number" == typeof t3) return fe(e2.R, t3);
    ...
    if (t3 instanceof pa2) return {
      geoPointValue: {
        latitude: t3.latitude,
        longitude: t3.longitude
      }
    };
    if (t3 instanceof la2) return {
      bytesValue: In(e2.R, t3._byteString)
    };
    if (t3 instanceof Yu) {
      n = e2.databaseId;
      var r = t3.firestore._databaseId;
      if (!r.isEqual(n)) throw e2.Mc("Document reference is for database " + r.projectId + "/" + r.database + " but should be for database " + n.projectId + "/" + n.database);
      return {
...
function Oa(t2) {
  return !("object" != typeof t2 || null === t2 || t2 instanceof Array || t2 instanceof Date || t2 instanceof B2 || t2 instanceof pa2 || t2 instanceof la2 || t2 instanceof Yu || t2 instanceof da2);
}
function Pa(t2, e, n) {
  if (!Oa(n) || !function(t3) {
    ...
    var r = Qu(n);
    throw "an object" === r ? e.Mc(t2 + " a custom object") : e.Mc(t2 + " " + r);
  }
}
function Fa2(t2, e, n) {
  if (
    ...
    // FieldPath.
    (e = getModularInstance(e)) instanceof fa2
  ) return e._internalPath;
  if ("string" == typeof e) return Va2(t2, e);
  throw qa2(
...
function Ka2(t2, e) {
  return "string" == typeof e ? Va2(t2, e) : e instanceof fa2 ? e._internalPath : e._delegate._internalPath;
}
var Qa = (
  /** @class */
  function() {
...
var Wa2 = (
  ...
  function() {
    ...
    t2.prototype.docChanges = function(t3) {
      ...
      if (e && this._snapshot.excludesMetadataChanges) throw new N2(S2.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
...
function Ya2(t2, e) {
  return t2 instanceof Ga2 && e instanceof Ga2 ? t2._firestore === e._firestore && t2._key.isEqual(e._key) && (null === t2._document ? null === e._document : t2._document.isEqual(e._document)) && t2._converter === e._converter : t2 instanceof Wa2 && e instanceof Wa2 && t2._firestore === e._firestore && ea2(t2.query, e.query) && t2.metadata.isEqual(e.metadata) && t2._snapshot.isEqual(e._snapshot);
}
function $a2(t2) {
  if ($t(t2) && 0 === t2.explicitOrderBy.length) throw new N2(S2.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
var Xa2 = function() {
};
function Ja2(t2) {
  ...
  function(e) {
    ...
    return __extends(n, e), n.prototype._apply = function(t2) {
      var e2 = Ia2(t2.firestore), n2 = function(t3, e3, n3, r, i, o, s) {
        var u;
        if (i.isKeyField()) {
          if ("array-contains" === o || "array-contains-any" === o) throw new N2(S2.INVALID_ARGUMENT, "Invalid Query. You can't perform '" + o + "' queries on FieldPath.documentId().");
          if ("in" === o || "not-in" === o) {
            sc2(s, o);
        ...
        } else "in" !== o && "not-in" !== o && "array-contains-any" !== o || sc2(s, o), u = xa2(
          n3,
          "where",
          s,
          /* allowArrays= */
        ...
        return function(t4, e4) {
          if (e4.g()) {
            var n4 = Jt(t4);
            if (null !== n4 && !n4.isEqual(e4.field)) throw new N2(S2.INVALID_ARGUMENT, "Invalid query. All where filters with an inequality (<, <=, !=, not-in, >, or >=) must be on the same field. But you have inequality filters on '" + n4.toString() + "' and '" + e4.field.toString() + "'");
            var r2 = Xt(t4);
            null !== r2 && uc2(t4, e4.field, r2);
          }
  ...
  function(e) {
    ...
    return __extends(n, e), n.prototype._apply = function(t2) {
      var e2 = function(t3, e3, n2) {
        if (null !== t3.startAt) throw new N2(S2.INVALID_ARGUMENT, "Invalid query. You must not call startAt() or startAfter() before calling orderBy().");
        if (null !== t3.endAt) throw new N2(S2.INVALID_ARGUMENT, "Invalid query. You must not call endAt() or endBefore() before calling orderBy().");
        var r = new jt(e3, n2);
        return function(t4, e4) {
          if (null === Xt(t4)) {
            var n3 = Jt(t4);
            null !== n3 && uc2(t4, n3, e4.field);
          }
        }(t3, r), r;
...
function ic2(t2, e, n, r) {
  if (n[0] = getModularInstance(n[0]), n[0] instanceof Ba) return function(t3, e2, n2, r2, i2) {
    if (!r2) throw new N2(S2.NOT_FOUND, "Can't use a DocumentSnapshot that doesn't exist for " + n2 + "().");
    for (var o = [], s = 0, u = te(t3); s < u.length; s++) {
      var a = u[s];
      if (a.field.isKeyField()) o.push(vt(e2, r2.key));
      else {
        var c = r2.data.field(a.field);
        if (nt(c)) throw new N2(S2.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + a.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
        if (null === c) {
  ...
  return function(t3, e2, n2, r2, i2, o) {
    ...
    if (i2.length > s.length) throw new N2(S2.INVALID_ARGUMENT, "Too many arguments provided to " + r2 + "(). The number of arguments must be less than or equal to the number of orderBy() clauses");
    for (var u = [], a = 0; a < i2.length; a++) {
      var c = i2[a];
      if (s[a].field.isKeyField()) {
        if ("string" != typeof c) throw new N2(S2.INVALID_ARGUMENT, "Invalid query. Expected a string for document ID in " + r2 + "(), but got a " + typeof c);
        if (!Zt(t3) && -1 !== c.indexOf("/")) throw new N2(S2.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + r2 + "() must be a plain document ID, but '" + c + "' contains a slash.");
        var h = t3.path.child(W2.fromString(c));
        if (!at.isDocumentKey(h)) throw new N2(S2.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + r2 + "() must result in a valid document path, but '" + h + "' is not because it contains an odd number of segments.");
        var f = new at(h);
        u.push(vt(e2, f));
      } else {
        var l2 = xa2(n2, r2, c);
...
function oc2(t2, e, n) {
  if ("string" == typeof (n = getModularInstance(n))) {
    if ("" === n) throw new N2(S2.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
    if (!Zt(e) && -1 !== n.indexOf("/")) throw new N2(S2.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
    var r = e.path.child(W2.fromString(n));
    if (!at.isDocumentKey(r)) throw new N2(S2.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + r + "' is not because it has an odd number of segments (" + r.length + ").");
    return vt(t2, new at(r));
  }
  if (n instanceof Yu) return vt(t2, n._key);
...
function sc2(t2, e) {
  if (!Array.isArray(t2) || 0 === t2.length) throw new N2(S2.INVALID_ARGUMENT, "Invalid Query. A non-empty array is required for '" + e.toString() + "' filters.");
  if (t2.length > 10) throw new N2(S2.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters support a maximum of 10 elements in the value array.");
}
function uc2(t2, e, n) {
  if (!n.isEqual(e)) throw new N2(S2.INVALID_ARGUMENT, "Invalid query. You have a where filter with an inequality (<, <=, !=, not-in, >, or >=) on field '" + e.toString() + "' and so you must also use '" + e.toString() + "' as your first argument to orderBy(), but your first orderBy() is on field '" + n.toString() + "' instead.");
}
var ac2 = (
  /** @class */
  function() {
    ...
    return t2.prototype.convertValue = function(t3, e) {
      ...
      C2("Document " + i + " contains a document reference within a different database (" + r.projectId + "/" + r.database + ") which is not supported. It will be treated as a reference in the current database (" + e.projectId + "/" + e.database + ") instead."), i;
    }, t2;
  }()
);
function cc2(t2, e, n) {
...
var fc2 = (
  ...
  function() {
    ...
    return t2.prototype.set = function(t3, e, n) {
      ...
      var r = lc2(t3, this._firestore), i = cc2(r.converter, e, n), o = Ea(this._dataReader, "WriteBatch.set", r._key, i, null !== r.converter, n);
      ...
      return o = "string" == typeof (e = getModularInstance(e)) || e instanceof fa2 ? Ca2(this._dataReader, "WriteBatch.update", s._key, e, n, r) : ka2(this._dataReader, "WriteBatch.update", s._key, e), this._mutations.push(o.toMutation(s._key, Ne.exists(true))), this;
    }, /**
    ...
    t2.prototype.commit = function() {
      ...
      if (this._committed) throw new N2(S2.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t2;
  }()
);
function lc2(t2, e) {
  if ((t2 = getModularInstance(t2)).firestore !== e) throw new N2(S2.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
  return t2;
}
var dc2 = (
  /** @class */
...
function pc2(t2, e, n) {
  ...
  return vc2(o, [("string" == typeof // For Compat types, we have to "extract" the underlying types before
  // performing validation.
  (e = getModularInstance(e)) || e instanceof fa2 ? Ca2(s, "updateDoc", t2._key, e, n, r) : ka2(s, "updateDoc", t2._key, e)).toMutation(t2._key, Ne.exists(true))]);
}
function yc2(t2) {
  ...
  "object" != typeof s[c] || ra2(s[c]) || (a = s[c], c++);
  var h, l2, d2, p2 = {
  ...
  if (t2 instanceof Yu) l2 = Gu(t2.firestore, sa2), d2 = Ht(t2._key.path), h = {
    next: function(e2) {
  ...
  function(e) {
    ...
    return __extends(n, e), n.prototype.get = function(t2) {
      ...
      return e.prototype.get.call(this, t2).then(function(t3) {
        return new Ga2(n2._firestore, i, r._key, t3._document, new Qa(
          /* hasPendingWrites= */
          false,
          /* fromCache= */
          false
    ...
    function() {
      ...
      return t2.prototype.get = function(t3) {
        ...
        var r = lc2(t3, this._firestore), i = cc2(r.converter, e, n), o = Ea(this._dataReader, "Transaction.set", r._key, i, null !== r.converter, n);
        return this._transaction.set(r._key, o), this;
      }, t2.prototype.update = function(t3, e, n) {
        for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
        var o, s = lc2(t3, this._firestore);
        return o = "string" == typeof (e = getModularInstance(e)) || e instanceof fa2 ? Ca2(this._dataReader, "Transaction.update", s._key, e, n, r) : ka2(this._dataReader, "Transaction.update", s._key, e), this._transaction.update(s._key, o), this;
      }, /**
       * Deletes the document referred to by the provided {@link DocumentReference}.
       *
       * @param documentRef - A reference to the document to be deleted.
...
function wc2() {
  if ("undefined" == typeof Uint8Array) throw new N2(S2.UNIMPLEMENTED, "Uint8Arrays are not available in this environment.");
}
function bc2() {
  if ("undefined" == typeof atob) throw new N2(S2.UNIMPLEMENTED, "Blobs are unavailable in Firestore in this environment.");
}
var Ic2 = (
  /** @class */
  function() {
  ...
  function() {
    ...
    return t2.prototype.enableIndexedDbPersistence = function(t3, e) {
      return function(t4, e2) {
        ...
        return ca(n, i, new hu(i, r.cacheSizeBytes, null == e2 ? void 0 : e2.forceOwnership));
      }(t3._delegate, {
        forceOwnership: e
      });
      ...
      return function(t4) {
        var e = this;
        if (t4._initialized && !t4._terminated) throw new N2(S2.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
        var i = new wr();
...
var Tc2 = (
  ...
  function() {
    ...
    return Object.defineProperty(t2.prototype, "_databaseId", {
      ...
      t3.merge || e.host === t3.host || x2("You are overriding the original host. If you did not intend to override your settings, use {merge: true}."), t3.merge && // Remove the property from the settings once the merge is completed
      ...
      void 0 === n && (n = {}), function(t4, e2, n2, r) {
        ...
        if ("firestore.googleapis.com" !== i.host && i.host !== e2 && x2("Host has been set in both settings() and useEmulator(), emulator host will be used"), t4._setSettings(Object.assign(Object.assign({}, i), {
          host: e2 + ":" + n2,
          ssl: false
        })), r.mockUserToken) {
          var o = createMockUserToken(r.mockUserToken), s = r.mockUserToken.sub || r.mockUserToken.user_id;
          if (!s) throw new N2(S2.INVALID_ARGUMENT, "mockUserToken must contain 'sub' or 'user_id' field!");
                ...
                switch (n.label) {
                  case 0:
                    return e3 = function(t6, e4) {
                      P2(t6).Gr.add(e4), // Immediately fire an initial event, indicating all existing listeners
                      // are in-sync.
                      e4.next();
                    }, [4, Du(t5)];
                  case 1:
      ...
      get: function() {
        if (!this.Zc) throw new N2(S2.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
        return this.Zc;
      },
      enumerable: false,
      configurable: true
      ...
      try {
        return new Pc2(this, function(t4, e) {
          if (t4 = Gu(t4, Hu), qu("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new N2(S2.INVALID_ARGUMENT, "Invalid collection ID '" + e + "' passed to function collectionGroup(). Collection IDs must not contain '/'.");
          return new $u(
            t4,
            /* converter= */
            null,
            ...
            return __awaiter(i, void 0, void 0, function() {
              ...
              return __generator(this, function(r) {
                switch (r.label) {
                  ...
                  case 1:
                    return n = r.sent(), new mu(t5.asyncQueue, n, e3, o).run(), [
                      2
                      /*return*/
                    ];
                }
...
var Ac2 = (
  ...
  function() {
    ...
    return t2.prototype.fromFirestore = function(t3, e) {
      ...
      return this._delegate.fromFirestore(new Oc2(this._firestore, n), null != e ? e : {});
...
var kc2 = (
  ...
  function() {
    ...
    return t2.su = function(e, n, r) {
      if (e.length % 2 != 0) throw new N2(S2.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + e.canonicalString() + " has " + e.length);
      ...
      try {
        return function(t4, e2, n) {
          ...
          return vc2(r, [Ea(Ia2(r), "setDoc", t4._key, i, null !== t4.converter, n).toMutation(t4._key, Ne.none())]);
        }(this._delegate, t3, e);
      } catch (t4) {
      ...
      try {
        return 1 === arguments.length ? pc2(this._delegate, t3) : pc2.apply(void 0, __spreadArray([this._delegate, t3, n], r));
      } catch (t4) {
      ...
      return ("cache" === (null == t3 ? void 0 : t3.source) ? function(t4) {
        ...
        return function(t5, e3) {
          ...
          return new Ga2(e2, o, t4._key, n, new Qa(
...
function xc2(t2) {
  for (var e = 0, n = t2; e < n.length; e++) {
    var r = n[e];
    if ("object" == typeof r && !ra2(r)) return r;
  }
  return {};
}
function Rc2(t2, e) {
  ...
  return {
    ...
    error: null === (n = (i = ra2(t2[0]) ? t2[0] : ra2(t2[1]) ? t2[1] : "function" == typeof t2[0] ? {
      next: t2[0],
      error: t2[1],
      complete: t2[2]
    } : {
...
var Pc2 = (
  ...
  function() {
    ...
    return t2.prototype.where = function(e, n, r) {
      ...
      try {
        return new t2(this.firestore, Ja2(this._delegate, function(t3) {
          return zu("limitToLast", t3), new ec2(
            "limitToLast",
            t3,
            "L"
            /* Last */
                        ...
                        return __awaiter(this, void 0, void 0, function() {
                          ...
                          return __generator(this, function(r) {
                            switch (r.label) {
                              ...
                              case 1:
                                return a = r.sent(), n = new Ds(e4, a.Bn), o3 = n._o(a.documents), s2 = n.applyChanges(
                                  o3,
                                  /* updateLimboDocuments= */
                                  false
...
var Vc2 = (
  ...
  function(e) {
    ...
    return __extends(n, e), Object.defineProperty(n.prototype, "id", {
      ...
      try {
        return new kc2(this.firestore, void 0 === t2 ? Zu(this._delegate) : Zu(this._delegate, t2));
      } catch (t3) {
      ...
      return function(t3, e3) {
        ...
        return vc2(n2, [Ea(Ia2(t3.firestore), "addDoc", r._key, i, null !== t3.converter, {}).toMutation(r._key, Ne.exists(false))]).then(function() {
          return r;
        });
  ...
  */
  function(e2, r) {
    e2.INTERNAL.registerComponent(new Component(
      ...
      "PUBLIC"
      /* PUBLIC */
    ).setServiceProps(Object.assign({}, P3)));
  }(e, function(e2, s) {
...
@firebase/firestore/dist/esm5/prebuilt-038c95ef-26ab9a06.js:
  (**
   * @license
